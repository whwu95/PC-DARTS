...
parser.add_argument('-b','--batch_size', type=int, metavar='N',default=1024, help='batch size')
...
parser.add_argument('--save', type=str, default='Imagenet-EXP', help='experiment name')
...
parser.add_argument('--begin', type=int, default=35, help='Epoch begins to train arch_param')
parser.add_argument('--data', type=str, default='/tmp/cache/', help='temp data dir')
...
def main():
  ...
  data_dir = args.data  #os.path.join(args.data, 'imagenet_search')
